...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const brandIdentitySection = document.getElementById("portfolio"); // Brand Visual Identity Section
  const tabsContainer = document.querySelector(".portfolio-tabs"); // Tabs Container
  ...
  tabs.forEach(tab => {
      tab.addEventListener("click", function () {
          ...
          // Hide all sections, including Brand Identity
          sections.forEach(section => section.style.display = "none");
          brandIdentitySection.style.display = "none"; // Hide Brand Visual Identity

          // Show the selected section
          if (targetSection) {
              targetSection.style.display = "block";

              // Scroll smoothly to the section but keep tabs in view
              window.scrollTo({
                  top: tabsContainer.offsetTop, // Keeps tabs visible
                  behavior: "smooth"
              });
          }
      });
...
document.addEventListener("DOMContentLoaded", function () {
  // Get elements for Hire Me Modal
  const hireMeModal = document.getElementById("hireMeModal");
  const hireMeBtn = document.getElementById("hireMeBtn");
  const hireMeClose = document.getElementById("hireMeClose");

  // Get elements for Branding Project Brief Modal
  const brandingBriefModal = document.getElementById("brandingBriefModal");
  const brandingBriefLink = document.getElementById("brandingBriefLink");
  const brandingBriefClose = document.getElementById("brandingBriefClose");
  ...
  // Close Hire Me Modal
  hireMeClose.addEventListener("click", function () {
      hireMeModal.style.display = "none";
  });

  // Open Branding Project Brief Modal
  brandingBriefLink.addEventListener("click", function (event) {
      event.preventDefault();
      brandingBriefModal.style.display = "flex";
  });

  // Close Branding Project Brief Modal
  brandingBriefClose.addEventListener("click", function () {
      brandingBriefModal.style.display = "none";
  });
  ...
  window.addEventListener("click", function (event) {
      ...
      if (event.target === brandingBriefModal) {
          brandingBriefModal.style.display = "none";
      }
  });
});
...
document.addEventListener("DOMContentLoaded", function () {
  const savePdfBtn = document.getElementById("savePdfBtn"); // Ensure this ID matches the button ID in your HTML
  const brandingForm = document.getElementById("branding-form");

  savePdfBtn.addEventListener("click", function () {
      if (typeof html2pdf !== "undefined") {
          html2pdf().from(brandingForm).save();
      } else {
